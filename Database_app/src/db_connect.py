# Třída DbConnection slouží k vytvoření spojení s databází MySQL. Implementuje Singleton design pattern, aby bylo zajištěno, že existuje pouze jedna instance této třídy.
