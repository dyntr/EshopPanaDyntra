...
<html lang="en">
<head>
    <!-- HTML dokument pro přihlašování a registraci uživatelů

    Tento soubor obsahuje HTML a CSS pro uživatelské rozhraní přihlašování a registrace v rámci webové aplikace.
    Používá Bootstrap pro responzivní design a poskytuje plynulé přechody mezi přihlašovací a registrační formou.
    Zahrnuje stylování a JavaScript pro interaktivitu. -->
    ...
    <style>
        <!-- CSS styly pro přihlašovací a registrační formuláře

        Tato část obsahuje veškeré stylování pro formuláře, včetně animací a přechodů mezi jednotlivými stavy (přihlášení a registrace).  -->
        ...
        * { box-sizing: border-box; }
        ...
        h1, h2, p, span, a, button, input { font-family: 'Montserrat', sans-serif; }
        ...
        .sign-in-container, .sign-up-container { left: 0; width: 50%; z-index: 2; }
    ...
    <script src="https://kit.fontawesome.com/a076d05399.js"></script> <!-- pro ikony sociálních sítí -->
</head>
<body>
<!--
Tělo HTML dokumentu obsahující přihlašovací a registrační formulář

Tato část obsahuje dva formuláře - jeden pro přihlášení a druhý pro registraci. Používá se animace pro přechod mezi formuláři.
-->
...
<!--
JavaScript pro animaci přepínání mezi přihlášením a registrací

Tento skript přidává a odstraňuje CSS třídu 'right-panel-active' pro přepínání mezi stavy přihlášení a registrace.
-->
